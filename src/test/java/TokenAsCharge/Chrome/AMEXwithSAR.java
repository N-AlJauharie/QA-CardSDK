...
public class AMEXwithSAR {
    ...
    public void AMEXwithSAR() {
        ...
        cardNumber.sendKeys("345678901234564");
        ...
        System.out.println("Currency: AED, Token ID: " + tokenId + ", Brand: AMEX, Scheme: AMEX");
    }
