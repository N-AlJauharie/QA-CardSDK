...
public class BenefitwithBHD {
    ...
    public void BenefitwithBHD() {
        ...
        selectCurrency.selectByVisibleText("BHD");
        ...
        cardNumber.sendKeys("4600410123456789");
        driver.findElement(By.id("date_input")).sendKeys("12/27");
        driver.findElement(By.id("cvv_input")).sendKeys("1234");
